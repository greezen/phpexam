            ...
            <form action="?exam-app-exercise-score" id="form1" name="form1" method="post">
            	<h2 class="page_title">
                    ...
                    <div id="fenshu">
                        ...
                        <div class="n<?php echo intval($this->tpl_var['sessionvars']['examsessionscore']/100%10); ?>"></div>
                        <?php } ?>
                        <?php if($this->tpl_var['sessionvars']['examsessionscore'] >= 10){ ?>
                        <div class="n<?php echo intval($this->tpl_var['sessionvars']['examsessionscore']/10%10); ?>"></div>
                        <?php } ?>
                        ...
                        <div class="ndot"></div>
                        <div style="display:none;" class="n<?php echo intval($this->tpl_var['sessionvars']['examsessionscore']*10%10); ?>"></div>
                        <?php } ?>
                    </div>
                    <!--分数 结束-->
                  </h2>
       	    	<h1><?php echo $this->tpl_var['sessionvars']['examsession']; ?></h1>
                <h5>总分：<span class="orange">100</span>分 合格分数线：<span class="orange">60</span>分 考试时间：<span class="orange"><?php echo $this->tpl_var['sessionvars']['examsessiontime']; ?></span>分钟 来源：东奥会计在线</h5>
                <?php $oid = 0; ?>
                <?php $qid = 0;
